...
object newtypes {
  ...
  implicit val conjunctionMonoid: Monoid[Boolean @@ Tags.Conjunction] = new Monoid[Boolean @@ Tags.Conjunction] {
    ...
    def combine(a: Boolean @@ Tags.Conjunction, b: Boolean @@ Tags.Conjunction): Boolean @@ Tags.Conjunction =
      @@(a.unwrap && b.unwrap)
  }
  ...
  implicit val disjunctionMonoid: Monoid[Boolean @@ Tags.Disjunction] = new Monoid[Boolean @@ Tags.Disjunction] {
    ...
    def combine(a: Boolean @@ Tags.Disjunction, b: Boolean @@ Tags.Disjunction): Boolean @@ Tags.Disjunction =
      @@(a.unwrap || b.unwrap)
  }
}
